About xvfbwrapper-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xvfbwrapper-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2231&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xvfbwrapper-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xvfbwrapper` can be installed with `conda`:
...
```
mamba install xvfbwrapper
```

It is possible to list all of the versions of `xvfbwrapper` available on your platform with `conda`:
...
```
mamba search xvfbwrapper --channel conda-forge
```
...
mamba repoquery search xvfbwrapper --channel conda-forge

# List packages depending on `xvfbwrapper`:
mamba repoquery whoneeds xvfbwrapper --channel conda-forge

# List dependencies of `xvfbwrapper`:
mamba repoquery depends xvfbwrapper --channel conda-forge
```
